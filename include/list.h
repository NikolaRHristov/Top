...
/* Remove element from list. */
static inline void list_del(struct list_head *elem) { __list_del(elem->prev, elem->next); }
...
#define list_for_each_entry_safe(pos, p, head, member)                                                                 \
  for (pos = list_entry((head)->next, __typeof__(*(pos)), member),                                                     \
      p = list_entry((pos)->member.next, __typeof__(*(pos)), member);                                                  \
       &(pos)->member != (head); pos = (p), p = list_entry((pos)->member.next, __typeof__(*(pos)), member))
...
#define list_for_each_entry_safe_from(pos, p, head, member)                                                            \
  for (p = list_entry((pos)->member.next, __typeof__(*(pos)), member); &(pos)->member != (head);                       \
