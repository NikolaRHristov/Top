...
static char *allMessages[] = {
    ...
    "This version of Nvtop does not yet support reporting all data for Intel GPUs, such as memory, power, fan and "
    "temperature information",
    "This version of Nvtop does not yet support reporting all data for MSM GPUs, such as power, fan and temperature "
    "information",
};
